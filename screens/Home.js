...
export default class HomeScreen extends Component {
  ...
  getMoviearticle = () => {
    const url = "http://localhost:5000/get-moviearticle";
    axios
      .get(url)
      .then(response => {
        let details = response.data.data;
        details["duration"] = this.timeConvert(details.duration);
        this.setState({ moviearticleDetails: details });
      })
      .catch(error => {
  ...
  likedMoviearticle = () => {
    const url = "http://localhost:5000/liked-moviearticle";
    axios
      .post(url)
      .then(response => {
        this.getMoviearticle();
  ...
  unlikedMoviearticle = () => {
    const url = "http://localhost:5000/unliked-moviearticle";
    axios
      .post(url)
      .then(response => {
        this.getMoviearticle();
        ...
        <View style={styles.container}>
          <View style={styles.headerContainer}>
            <Header
              ...
              rightComponent={{
                icon: "moviearticle-open",
                color: "#fff",
                type: "material-community",
                onPress: () =>
                  this.props.navigation.navigate("RecommendedMoviearticles")
              }}
